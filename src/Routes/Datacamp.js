    ...
    <div className='text-white mb-10 mt-20'>
      ...
      <div className="flex items-center justify-center relative z-10 mt-10">
        <div className="max-w-full p-4 md:p-10 w-full mx-5 md:mx-20 overflow-hidden bg-black text-white rounded-lg shadow-lg">
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
            <div className="ml-0 md:ml-10 w-full md:w-2/3 mt-4 md:mt-0">
              <h2 className="text-3xl font-bold text-white mb-5">Why DataCamp?</h2>
              ...
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSc3d-ApKJDxLztekpShKK3GCVdhWWyj7B_voYcT1nt3DreuSg/viewform" className="inline-block px-6 py-3 mt-10 text-white bg-blue-500 hover:bg-blue-600 rounded-md transition duration-300">Share Your Story</a>

            </div>
            <div className="overflow-hidden w-full md:w-1/3 ml-20">
              <div className="relative w-full h-96 md:h-auto shadow-md">
                <video className="w-full h-full max-w-80" controls looped autoPlay muted>
      ...
      <div className="flex items-center justify-center relative z-10 mt-10">
        <div className="max-w-full p-4 md:p-10 w-full mx-5 md:mx-20 overflow-hidden bg-black text-white rounded-lg shadow-lg">
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
            <div className="ml-0 md:ml-10 w-full md:w-2/3 mt-4 md:mt-0">
              <h2 className="text-3xl font-bold text-white mb-5">Unleash Your Potential in Data Hackathons with DataCamp Workspace </h2>
              <p className="mt-2 text-base text-white">Whether an experienced data professional or a newcomer, the DataCamp Workspace equips individuals with the resources to excel in Data Hackathons, making a mark in the data science community.</p>
              <p className="mt-2 text-base text-white">DataCamp's innovation is evident through features like the DataCamp Workspace, which is a game-changer in the data science learning landscape. This new tool transforms Data Hackathons by providing an integrated platform for participants. In this Workspace, users can collaborate seamlessly, tackle challenges using real-world datasets, and access learning materials. The Workspace's flexibility and streamlined workflow enhance productivity and creativity, essential in time-constrained competitions.</p>
            </div>
            <div className="md:w-1/3 md:ml-20 mt-4 md:mt-0">
              <h2 className="text-3xl font-bold text-white mb-5">How to apply for DataCamp License?</h2>
              <p className="mt-2 text-base text-white">You'll be directed to a Google Forms page. This is where you need to fill out the necessary information. </p>
              <p className="mt-2 text-base text-white">The organizers will review the submitted forms and verify the information you provided. You will be notified through email in 1 to 2 weeks. It will include instructions on how to access the DataCamp license. </p>
              <p className="mt-2 text-base text-white">Once you're logged in, you will have access to 400+ courses covered by license. Just like that, you can explore the courses and start learning.</p>
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSdft5DH7TaV5zv3GAbXKJYiBaksb4lcuuETF-_G5mMHD3LHWA/viewform" className="inline-block px-6 py-3 mt-10 text-white bg-blue-500 hover:bg-blue-600 rounded-md transition duration-300">Apply Now</a>
            </div>
          </div>
        </div>
      </div>
